...
//  Coursera
//
//  Created by Saksham Ram Khatod on 24/07/19.
    ...
    var body: some View {
        VStack(spacing: 20.0) {
            Rectangle()
                ...
                .cornerRadius(3.0)
                .opacity(0.1)
            Text("This certificate is proof that Saksham Khatod has finished the UI Design Course")
        ...
        .cornerRadius(30)
        .shadow(radius: 20)
        .offset(y: UIScreen.main.bounds.height-220)
    }
}
